...
Download the latest .ankiaddon file from the Releases page.

Open Anki.

Go to Tools → Add-ons → Install from file.

Select the MELO .ankiaddon file.

Restart Anki.

On first launch, MELO asks:

What should I call you?

Enter the name you want MELO to use.
...
Recursively import supported audio files from a folder
...
Choose a custom selector background

RESET BACKGROUND

Restore the default selector background
...
Click anywhere or drag to seek
...
Select ADD CURRENT TO PLAYLIST.
...
Select/play the currently highlighted DISC track
...
MELO uses a supplied vinyl texture for the record display.
...
The player remains constrained to the Anki window while being moved or resized.
...
This allows preferences, library data, playlists, Favorites, and the selected browsing mode to persist between restarts.
...
Download the installable .ankiaddon package from the MELO v1.0 release.

Author

Yuki

Project: MELO — Personal Music Player for Anki
