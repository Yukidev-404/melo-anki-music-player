...
MELO v1.0.2 adds improved library management and high-resolution vinyl assets.
...
The latest MELO release, adding folder-based library removal and the high-resolution vinyl/tonearm update while retaining the original v1.0 and v1.0.1 feature set.
