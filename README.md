...
MELO v1.0.1 adds persistent player positioning.

- The music player's position is saved when you move it.
- Restarting Anki restores the player to its last saved position.
- Resizing the player does not reset its saved position.
- The existing MELO v1.0 features remain available.
...
The latest MELO release, adding persistent music-player positioning while retaining the original v1.0 feature set.

Download the installable `.ankiaddon` package from the [MELO v1.0.1 release](../../releases/tag/v1.0.1).
